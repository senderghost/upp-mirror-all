           ...
           gint      *height)
{
  ...
  hoveredarrowmenuitem_context = get_style (menu_context, "menuitem:hover");
                 ...
                 gint      *height)
{
  ...
  *height = 0;
  ...
  icon_info = gtk_icon_theme_lookup_icon (icon_theme, "list-add-symbolic", icon_size, (GtkIconLookupFlags)0);
  ...
  gtk_style_context_get (down_context, gtk_style_context_get_state (down_context),
                         "min-width", &icon_width, "min-height", &icon_height, NULL);
  icon_size = MIN (icon_width, icon_height);
  icon_info = gtk_icon_theme_lookup_icon (icon_theme, "list-remove-symbolic", icon_size, (GtkIconLookupFlags)0);
         ...
         cairo_t   *cr)
{
  ...
  y += height + 8;
  draw_horizontal_scrollbar (widget, cr, x, y, panewidth - 20, 50, (GtkStateFlags)(GTK_STATE_FLAG_ACTIVE|GTK_STATE_FLAG_PRELIGHT), &height);
