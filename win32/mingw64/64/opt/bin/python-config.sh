...
prefix_build="/c/mingw620/x86_64-620-win32-seh-rt_v5-rev1/mingw64/opt"
...
CFLAGS=$(echo "-O2 -pipe -I/c/mingw620/x86_64-620-win32-seh-rt_v5-rev1/mingw64/opt/include -I/c/mingw620/prerequisites/x86_64-zlib-static/include -I/c/mingw620/prerequisites/x86_64-w64-mingw32-static/include -fwrapv -DNDEBUG -D__USE_MINGW_ANSI_STDIO=1" | sed "s#$prefix_build#$prefix_real#")
VERSION="2.7"
LIBM="-lm"
LIBC=""
SYSLIBS="$LIBM $LIBC"
